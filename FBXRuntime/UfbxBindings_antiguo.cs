...
namespace Ufbx_old
{
    ...
    public partial struct ufbx_prop
    {
        ...
        [UnscopedRef]
        public Span<double> value_real_arr
        {
            get
            {
    ...
    public unsafe partial struct ufbx_allocator
    {
        ...
        public delegate void ufbx_free_fn(void* user, void* ptr, UIntPtr size);

        [NativeTypeName("ufbx_realloc_fn *")]
        public delegate* unmanaged[Cdecl]<void*, void*, UIntPtr, UIntPtr, void*> realloc_fn;

        [NativeTypeName("ufbx_free_fn *")]
        public delegate* unmanaged[Cdecl]<void*, void*, UIntPtr, void> free_fn;
    ...
    public unsafe partial struct ufbx_stream
    {
        ...
        public delegate* unmanaged[Cdecl]<void*, void*, UIntPtr, UIntPtr> read_fn;

        [NativeTypeName("ufbx_skip_fn *")]
        public delegate* unmanaged[Cdecl]<void*, UIntPtr, byte> skip_fn;
    ...
    public unsafe partial struct ufbx_open_file_cb
    {
        ...
        public delegate* unmanaged[Cdecl]<void*, ufbx_stream*, sbyte*, UIntPtr, ufbx_open_file_info*, byte> fn;
    ...
    public unsafe partial struct ufbx_close_memory_cb
    {
        ...
        public delegate* unmanaged[Cdecl]<void*, void*, UIntPtr, void> fn;
    ...
    public unsafe partial struct ufbx_thread_pool
    {
        ...
        public delegate* unmanaged[Cdecl]<void*, UIntPtr, ufbx_thread_pool_info*, byte> init_fn;

        [NativeTypeName("ufbx_thread_pool_run_fn *")]
        public delegate* unmanaged[Cdecl]<void*, UIntPtr, uint, uint, uint, void> run_fn;

        [NativeTypeName("ufbx_thread_pool_wait_fn *")]
        public delegate* unmanaged[Cdecl]<void*, UIntPtr, uint, uint, void> wait_fn;

        [NativeTypeName("ufbx_thread_pool_free_fn *")]
        public delegate* unmanaged[Cdecl]<void*, UIntPtr, void> free_fn;
    ...
    {
        public const int UFBX_ROTATION_ORDER_COUNT = UFBX_ROTATION_ORDER_SPHERIC + 1;

        public const int UFBX_DOM_VALUE_TYPE_COUNT = UFBX_DOM_VALUE_ARRAY_IGNORED + 1;

        public const int UFBX_PROP_TYPE_COUNT = UFBX_PROP_REFERENCE + 1;

        public const int UFBX_ELEMENT_TYPE_COUNT = UFBX_ELEMENT_METADATA_OBJECT + 1;

        public const int UFBX_INHERIT_MODE_COUNT = UFBX_INHERIT_MODE_COMPONENTWISE_SCALE + 1;

        public const int UFBX_MIRROR_AXIS_COUNT = UFBX_MIRROR_AXIS_Z + 1;

        public const int UFBX_SUBDIVISION_DISPLAY_MODE_COUNT = UFBX_SUBDIVISION_DISPLAY_SMOOTH + 1;

        public const int UFBX_SUBDIVISION_BOUNDARY_COUNT = UFBX_SUBDIVISION_BOUNDARY_SHARP_INTERIOR + 1;

        public const int UFBX_LIGHT_TYPE_COUNT = UFBX_LIGHT_VOLUME + 1;

        public const int UFBX_LIGHT_DECAY_COUNT = UFBX_LIGHT_DECAY_CUBIC + 1;

        public const int UFBX_LIGHT_AREA_SHAPE_COUNT = UFBX_LIGHT_AREA_SHAPE_SPHERE + 1;

        public const int UFBX_PROJECTION_MODE_COUNT = UFBX_PROJECTION_MODE_ORTHOGRAPHIC + 1;

        public const int UFBX_ASPECT_MODE_COUNT = UFBX_ASPECT_MODE_FIXED_HEIGHT + 1;

        public const int UFBX_APERTURE_MODE_COUNT = UFBX_APERTURE_MODE_FOCAL_LENGTH + 1;

        public const int UFBX_GATE_FIT_COUNT = UFBX_GATE_FIT_STRETCH + 1;

        public const int UFBX_APERTURE_FORMAT_COUNT = UFBX_APERTURE_FORMAT_IMAX + 1;

        public const int UFBX_COORDINATE_AXIS_COUNT = UFBX_COORDINATE_AXIS_UNKNOWN + 1;

        public const int UFBX_NURBS_TOPOLOGY_COUNT = UFBX_NURBS_TOPOLOGY_CLOSED + 1;

        public const int UFBX_MARKER_TYPE_COUNT = UFBX_MARKER_IK_EFFECTOR + 1;

        public const int UFBX_LOD_DISPLAY_COUNT = UFBX_LOD_DISPLAY_HIDE + 1;

        public const int UFBX_SKINNING_METHOD_COUNT = UFBX_SKINNING_METHOD_BLENDED_DQ_LINEAR + 1;

        public const int UFBX_CACHE_FILE_FORMAT_COUNT = UFBX_CACHE_FILE_FORMAT_MC + 1;

        public const int UFBX_CACHE_DATA_FORMAT_COUNT = UFBX_CACHE_DATA_FORMAT_VEC3_DOUBLE + 1;

        public const int UFBX_CACHE_DATA_ENCODING_COUNT = UFBX_CACHE_DATA_ENCODING_BIG_ENDIAN + 1;

        public const int UFBX_CACHE_INTERPRETATION_COUNT = UFBX_CACHE_INTERPRETATION_VERTEX_NORMAL + 1;

        public const int UFBX_SHADER_TYPE_COUNT = UFBX_SHADER_WAVEFRONT_MTL + 1;

        public const int UFBX_MATERIAL_FBX_MAP_COUNT = UFBX_MATERIAL_FBX_VECTOR_DISPLACEMENT + 1;

        public const int UFBX_MATERIAL_PBR_MAP_COUNT = UFBX_MATERIAL_PBR_TRANSMISSION_GLOSSINESS + 1;

        public const int UFBX_MATERIAL_FEATURE_COUNT = UFBX_MATERIAL_FEATURE_TRANSMISSION_ROUGHNESS_AS_GLOSSINESS + 1;

        public const int UFBX_TEXTURE_TYPE_COUNT = UFBX_TEXTURE_SHADER + 1;

        public const int UFBX_BLEND_MODE_COUNT = UFBX_BLEND_OVERLAY + 1;

        public const int UFBX_WRAP_MODE_COUNT = UFBX_WRAP_CLAMP + 1;

        public const int UFBX_SHADER_TEXTURE_TYPE_COUNT = UFBX_SHADER_TEXTURE_OSL + 1;

        public const int UFBX_INTERPOLATION_COUNT = UFBX_INTERPOLATION_CUBIC + 1;

        public const int UFBX_EXTRAPOLATION_MODE_COUNT = UFBX_EXTRAPOLATION_REPEAT_RELATIVE + 1;

        public const int UFBX_CONSTRAINT_TYPE_COUNT = UFBX_CONSTRAINT_SINGLE_CHAIN_IK + 1;

        public const int UFBX_CONSTRAINT_AIM_UP_TYPE_COUNT = UFBX_CONSTRAINT_AIM_UP_NONE + 1;

        public const int UFBX_CONSTRAINT_IK_POLE_TYPE_COUNT = UFBX_CONSTRAINT_IK_POLE_NODE + 1;

        public const int UFBX_EXPORTER_COUNT = UFBX_EXPORTER_UFBX_WRITE + 1;

        public const int UFBX_FILE_FORMAT_COUNT = UFBX_FILE_FORMAT_MTL + 1;

        public const int UFBX_WARNING_TYPE_COUNT = UFBX_WARNING_UNKNOWN_OBJ_DIRECTIVE + 1;

        public const int UFBX_THUMBNAIL_FORMAT_COUNT = UFBX_THUMBNAIL_FORMAT_RGBA_32 + 1;

        public const int UFBX_SPACE_CONVERSION_COUNT = UFBX_SPACE_CONVERSION_MODIFY_GEOMETRY + 1;

        public const int UFBX_GEOMETRY_TRANSFORM_HANDLING_COUNT = UFBX_GEOMETRY_TRANSFORM_HANDLING_MODIFY_GEOMETRY_NO_FALLBACK + 1;

        public const int UFBX_INHERIT_MODE_HANDLING_COUNT = UFBX_INHERIT_MODE_HANDLING_IGNORE + 1;

        public const int UFBX_PIVOT_HANDLING_COUNT = UFBX_PIVOT_HANDLING_ADJUST_TO_ROTATION_PIVOT + 1;

        public const int UFBX_TIME_MODE_COUNT = UFBX_TIME_MODE_59_94_FPS + 1;

        public const int UFBX_TIME_PROTOCOL_COUNT = UFBX_TIME_PROTOCOL_DEFAULT + 1;

        public const int UFBX_SNAP_MODE_COUNT = UFBX_SNAP_MODE_SNAP_AND_PLAY + 1;

        public const int UFBX_OPEN_FILE_TYPE_COUNT = UFBX_OPEN_FILE_OBJ_MTL + 1;

        public const int UFBX_ERROR_TYPE_COUNT = UFBX_ERROR_UNSUPPORTED_VERSION + 1;

        public const int UFBX_INDEX_ERROR_HANDLING_COUNT = UFBX_INDEX_ERROR_HANDLING_UNSAFE_IGNORE + 1;

        public const int UFBX_UNICODE_ERROR_HANDLING_COUNT = UFBX_UNICODE_ERROR_HANDLING_UNSAFE_IGNORE + 1;

        public const int UFBX_BAKE_STEP_HANDLING_COUNT = UFBX_BAKE_STEP_HANDLING_IGNORE + 1;
        ...
        public static extern nint ufbx_inflate(void* dst, [NativeTypeName("size_t")] UIntPtr dst_size, [NativeTypeName("const ufbx_inflate_input *")] ufbx_inflate_input* input, ufbx_inflate_retain* retain);
